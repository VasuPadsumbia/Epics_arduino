...
/* Generated from ../O.Common/helloWorldIOC.dbd */
...
int helloWorldIOC_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/vasu/helloWorldIOC";
...
/* helloWorldIOC_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"helloWorldIOC_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    helloWorldIOC_registerRecordDeviceDriver(*iocshPpdbbase);
}
